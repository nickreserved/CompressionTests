...
namespace MGroup.Solvers.Iterative
{
	...
	/// </summary>
	public class PcgSolver2 : SingleSubdomainSolverBase<DuViCompressedSparseMatrix>
	{
		...
		private PcgSolver2(GlobalAlgebraicModel<DuViCompressedSparseMatrix> model, PcgAlgorithm pcgAlgorithm,
			IPreconditioner preconditioner, bool matrixPatternWillNotBeModified)
			: base(model, "PcgSolver2")
		{
		...
		public class Factory
		{
			...
			public PcgSolver2 BuildSolver(GlobalAlgebraicModel<DuViCompressedSparseMatrix> model)
				=> new PcgSolver2(model, PcgAlgorithm, Preconditioner.CopyWithInitialSettings(), MatrixPatternWillNotBeModified);

			public GlobalAlgebraicModel<DuViCompressedSparseMatrix> BuildAlgebraicModel(IModel model)
				=> new GlobalAlgebraicModel<DuViCompressedSparseMatrix>(model, DofOrderer, new CompressedSparseMatrixAssembler());
		}
	}
}
